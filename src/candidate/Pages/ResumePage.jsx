...
const ResumePage = () => {
  return (
    <>
      <main className="min-h-150  text-slate-900">
        <section className="max-w-6xl mx-auto px-6 py-12 lg:py-16">
          ...
          <header className="text-start mb-2">
            ...
            <h3 className="mt-3 text-[17px] sm:text-lg text-slate-600">
          ...
          <div className="flex flex-col-reverse lg:flex-row items-center gap-10 lg:gap-16">
            ...
            <div className="w-full lg:w-1/2 space-y-4">
              <h2 className="text-[25px] sm:text-3xl font-bold">
                Create your resume in minutes
              </h2>
              <p className="text-slate-600 text-[17px] sm:text-base">
              ...
              <Link to="/candidate/resumebuilder">
                <button className="mt-4 inline-flex items-center gap-2 rounded-2xl bg-gradient-to-r from-purple-600 to-violet-500 text-white px-6 py-3 text-[15px] sm:text-base font-semibold shadow-lg hover:from-purple-700 hover:to-violet-600 focus:outline-none focus:ring-4 focus:ring-indigo-200 transition-all">
                  Create resume
                </button>
              </Link>
