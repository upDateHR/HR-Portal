...
export default function HomePage() {
  return (
    <>
      <main
        className={`bg-gradient-to-b from-${UPSTOX_LIGHT_GRAY} to-white text-gray-900`}
      >
        <motion.section
          ...
          <section className="max-w-7xl mx-auto px-6 sm:px-10 py-8 lg:pt-20">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
              ...
              <div className="lg:col-span-6 order-1 lg:order-2">
                <h1 className="text-[35px] sm:text-5xl font-extrabold leading-tight tracking-tight">
        ...
        <section className="max-w-7xl mx-auto px-6 sm:px-10 py-5">
          <div className="flex flex-col justify-start lg:flex-row lg:items-center gap-6">
            <div className="text-center lg:text-left flex-shrink-0">
              <h2
                className={`text-2xl font-bold text-${UPSTOX_PURPLE} leading-tight`}
              >
                Top Roles
              </h2>
                ...
                {[
                  ...
                  <li key={item.label} className="flex-shrink-0">
                    ...
                    >
                      ...
                      <span
                        className={`flex h-8 w-8 items-center justify-center rounded-lg bg-purple-50 text-${UPSTOX_PURPLE} text-lg`}
                      >
                        {item.emoji}
                      </span>
        ...
        <section className="max-w-7xl mx-auto px-6 sm:px-10 py-10">
          <div
            className={`flex flex-col lg:flex-row items-center gap-12 rounded-xl shadow-2xl border border-gray-100 p-8 bg-white/70 backdrop-blur 
          ...
          >
            <div className="space-y-4 flex flex-col justify-start text-start w-full lg:w-1/2">
              ...
              <ul
                className={`space-y-2 text-gray-700 font-medium list-none text-base`}
              >
                {/* Icons changed to branded purple dots */}
                <li>
                  <span
                    className={`text-${UPSTOX_TEXT_PURPLE} font-extrabold mr-2`}
                  >
                    •
                  </span>{" "}
                ...
                <li>
                  ...
                  Perfect for freshers and first-time job seekers
                </li>
              </ul>
