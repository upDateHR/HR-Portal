  ...
  return (
    <nav className="w-full bg-white shadow-md fixed top-0 left-0 z-50">
      <div className="flex items-center justify-between px-6 py-4 md:px-10">
        ...
        {/* Login Button */}
        <button className="hidden md:block px-5 py-2 bg-indigo-600 text-white rounded-md hover:bg-indigo-700 transition">
          Login
        </button>
      ...
      {open && (
        <div className="md:hidden bg-white border-t">
          ...
          <div className="px-6 pb-4">
            <button className="w-full px-5 py-2 bg-indigo-600 text-white rounded-md hover:bg-indigo-700 transition">
              Login
            </button>
          </div>
        </div>
